...
const geometry = new THREE.TorusGeometry(6, 1, 16, 7);
...
const ambientLight = new THREE.AmbientLight(0x003333);
...
const boxTexture = new THREE.TextureLoader().load('profile.jpg');
...
const moonTexture = new THREE.TextureLoader().load('moon-surface1k.jpg');
